...
print(
    f"I could think to do was to {bold(verb_2)} over and over. Miraculously,")
...
print(
    f"I know, the whole story seems to be an AI nonsense or like {bold(article)} {bold(adjective_2)} dream.")
print("However, it is a true story, definitely not chatGPT. I hope you enjoyed it!")
